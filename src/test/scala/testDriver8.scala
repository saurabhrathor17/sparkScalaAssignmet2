...
class testDriver8 extends AnyFunSuite {
  ...
  val list = List("DEBUG, 2017-03-23T09:10:00+00:00, ghtorrent-34 -- retriever.rb: Commit Yangmaomao/jquery-pjax -> 8b442cbe679560fe468165226f4b377a6ee55589 exists",
    ...
    "INFO, 2017-03-23T11:07:16+00:00, ghtorrent-33 -- api_client.rb: Successful request. URL: https://api.github.com/repos/hello/interview/issues?state=closed&per_page=100, Remaining: 3508, Total: 68 ms",
    "INFO, 2017-03-23T11:07:16+00:00, ghtorrent-35-- api_client.rb: Successful request. URL: https://api.github.com/repos/hello/interview/issues?state=closed&per_page=100, Remaining: 3508, Total: 68 ms",
    "INFO, 2017-03-23T11:07:16+00:00, ghtorrent-35 -- api_client.rb: Successful request. URL: https://api.github.com/repos/hello/interview/issues?state=closed&per_page=100, Remaining: 3508, Total: 68 ms",
    "INFO, 2017-03-23T11:07:16+00:00, ghtorrent-35 -- api_client.rb: Successful request. URL: https://api.github.com/repos/hello/interview/issues?state=closed&per_page=100, Remaining: 3508, Total: 68 ms")
  ...
  // test cases - positive
  assert(Service.mostActiveRepo(DF) === "hello/interview")

  // test cases - negative
  //  assert(Service.mostActiveRepo(DF)==="hello/interviewl")
}
